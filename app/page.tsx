...
export default function PlainKioskPage() {
  ...
  async function handleClock(type: "CLOCK_IN" | "CLOCK_OUT") {
    ...
    try {
      ...
      setLastUser({ name: result.employee.name, type: result.entry.type });
      setMessage("");
      ...
      <div className="mx-auto max-w-7xl px-6 py-10 lg:px-12">
        ...
        <div className="grid gap-12 lg:grid-cols-12 items-start">
          ...
          <div className="lg:col-span-12 space-y-12">
            ...
            <section className="bg-white border-2 max-w-[700px] h-[700px] mx-auto border-slate-200 rounded-3xl p-4 md:p-10 shadow-sm relative overflow-hidden flex flex-col">
